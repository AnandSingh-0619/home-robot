...
JOB_ID=${SLURM_JOB_ID}
CHECKPOINT_DIR="data/new_checkpoints/navObj_Comp_640_yolo_scratch_943759"
TENSORBOARD_DIR="Logs/tensorLogs/navObj_Comp_640_yolo_scratch_${JOB_ID}"
LOG_DIR="Logs/logs/navObj/navObj_Comp_640_yolo_scratch_${JOB_ID}.log"
set -x
source ~/.bashrc
