...
JOB_ID=${SLURM_JOB_ID}
CHECKPOINT_DIR="data/new_checkpoints/navObj_og_${JOB_ID}"
TENSORBOARD_DIR="Logs/tensorLogs/navObj_og_${JOB_ID}"
LOG_DIR="Logs/logs/navObj_og_${JOB_ID}.log"
...
srun python -um habitat_uncertainty.run \
    --exp-config=projects/habitat_uncertainty/config/nav_to_obj.yaml \
    --run-type=train \
