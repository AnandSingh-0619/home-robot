...
JOB_ID=${SLURM_JOB_ID}
CHECKPOINT_DIR="data/new_checkpoints/navObj_nPolicy_${JOB_ID}"
TENSORBOARD_DIR="Logs/tensorLogs/navObj_nPolicy_${JOB_ID}"
LOG_DIR="Logs/logs/navObj_nPolicy_${JOB_ID}.log"
